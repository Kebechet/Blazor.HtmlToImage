...
public class HtmlToImageOptionsTests
{
    ...
    [Fact]
    public void Serialize_StabilisationMembers_AreCarriedForTheInteropLayer()
    {
        // Arrange
        var options = new HtmlToImageOptions
        {
        ...
        // Assert
        // Consumed by captureSettings() in html-to-image-interop.js and stripped there before the
        // options reach html-to-image - like the exclude members, these are wrapper-only.
        json.ShouldContain("\"stabilizeAttempts\"");
        json.ShouldContain("\"captureTimeoutMs\"");
    }
